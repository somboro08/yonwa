...
// Define PDF colors that map to YonwaColors
class PdfYonwaColors {
  static const PdfColor primary500 = PdfColor.fromInt(0xFFE2725B); // Brand color (Terre cuite)
  static const PdfColor neutral0 = PdfColor.fromInt(0xFFFFFFFF); // White
  static const PdfColor neutral50 = PdfColor.fromInt(0xFFFAF9F7);
  static const PdfColor neutral100 = PdfColor.fromInt(0xFFF2F0EC);
  static const PdfColor neutral200 = PdfColor.fromInt(0xFFE5E2DC);
  static const PdfColor neutral300 = PdfColor.fromInt(0xFFCCC8BF);
  static const PdfColor neutral400 = PdfColor.fromInt(0xFF9E9A92);
  static const PdfColor neutral500 = PdfColor.fromInt(0xFF706C65); // Grey
  static const PdfColor neutral600 = PdfColor.fromInt(0xFF4A4740);
  static const PdfColor neutral700 = PdfColor.fromInt(0xFF2E2B25);
  static const PdfColor neutral800 = PdfColor.fromInt(0xFF1E1C18);
  static const PdfColor neutral900 = PdfColor.fromInt(0xFF12100D); // Black
}
...
class PdfService {
  ...
  Future<void> _loadAssets() async {
    ...
    // Using existing asset if yonwa.png doesn't exist yet, but rebranding the string
    final ByteData imageData = await rootBundle.load('assets/icons/yoma.jpeg');
        ...
        build: (pw.Context context) {
          return pw.Column(
            ...
            children: [
                    ...
                    pw.Column(
                      ...
                      children: [
                        pw.Text('Reçu de Réservation',
                            style: pw.TextStyle(
                                font: _poppinsBold, fontSize: 24, color: PdfYonwaColors.primary500)),
                        pw.Text('Yonwa',
                            style: pw.TextStyle(
                                font: _poppinsRegular, fontSize: 18, color: PdfYonwaColors.neutral800)),
                      ],
                    ),
              ...
              _buildInfoRow('Référence de Réservation', '#YONWA-${DateTime.now().millisecondsSinceEpoch}', _poppinsRegular, _poppinsBold),
              ...
              pw.Center(
                child: pw.Text("Merci d'avoir choisi Yonwa !",
                    style: pw.TextStyle(font: _poppinsRegular, fontSize: 16, fontStyle: pw.FontStyle.italic, color: PdfYonwaColors.neutral500)),
              ),
              pw.Spacer(),
              pw.Center(
                child: pw.Text('Document généré par Yonwa App le ${dateFormat.format(DateTime.now())}',
                    style: pw.TextStyle(font: _poppinsRegular, fontSize: 8, color: PdfYonwaColors.neutral400)),
              ),
            ],
          );
        },
            ...
            children: [
              ...
              pw.Text(label,
                  style: pw.TextStyle(
                    ...
                    color: isTotal ? PdfYonwaColors.neutral800 : PdfYonwaColors.neutral600,
                  )),
            ],
          ),
          pw.Text(value,
              style: pw.TextStyle(
                ...
                color: isTotal ? PdfYonwaColors.primary500 : PdfYonwaColors.neutral800,
              )),
        ],
      ),
    );
